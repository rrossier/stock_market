...
<?php $user->get_navbar(); ?>
	...
	<div class="well">
      ...
      <tr><th>Ticker</th><th>Price</th><th>Quantity</th><th>Date</th></tr>
		<?php
		$tab=$user->get_historique();
		foreach($tab as $line){
			echo "<tr><td><a href='stock.php?stock=".$line['uuid_stock']."'>".$line['uuid_stock']."</a></td><td>".$line['price']."</td><td>".$line['quantity']."</td><td>".date("d-m-y H:i:s",strtotime($line['datetime']))."</td></tr>";
		}
		?>
		</table>
	</div>

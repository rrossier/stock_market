    ...
    <div class="container">
      ...
      <div id="myTabContent" class="tab-content">
        <div class="tab-pane fade in active" id="richest"><h3>Richest</h3>
          <p>
          <?php
          $data=Gamemaster::getBestTraders();
          if(!empty($data)){
            echo "<table  class='table table-condensed table-striped'>";
            echo "<tr><th>Trader</th><th>Valuation</th></tr>";
            foreach ($data as $line) {
              $trader=$line['trader'];
              $valuation=$line['last_valuation'];
              echo "<tr>";
              echo "<td><a href='../trader/trader?id=".$trader->id."'>".safe($trader->get_name())."</a></td>";
        ...
        <div class="tab-pane fade" id="weekly"><h3>Weekly Performance</h3>
          <p>
          <?php
          $data=Gamemaster::getBestWeeklyTraders();
          if(!empty($data)){
            echo "<table  class='table table-condensed table-striped'>";
            echo "<tr><th>Trader</th><th>Valuation</th></tr>";
            foreach ($data as $line) {
              ...
              echo "<tr>";
              echo "<td><a href='../trader/trader?id=".$trader->id."'>".safe($trader->get_name())."</a></td>";
              echo "<td>".number_format($perf,'2','.',' ')."%</td>";
              echo "</tr>";
            }
            echo "</table>";
          }
        ...
        <div class="tab-pane fade" id="monthly"><h3>Monthly Performance</h3>
          <p>
          <?php
          $data=Gamemaster::getBestMonthlyTraders();
          if(!empty($data)){
            echo "<table  class='table table-condensed table-striped'>";
            echo "<tr><th>Trader</th><th>Valuation</th></tr>";
            foreach ($data as $line) {

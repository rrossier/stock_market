...
$tickers=Gamemaster::getTickers('sbf120');
...
$stocks=array();
$handle = fopen($file, "r");
$sql="INSERT INTO sbf120_temp (symbol, name, last_trade, bid_realtime, ask_realtime, bid, ask, date, time, change_realtime, volume, change_day) VALUES ";
...
$connexion->exec("TRUNCATE TABLE sbf120_temp");

...
$sp500_tickers=Gamemaster::getTickers('sp500');
$start=microtime();
$tickers=array();
$tickers[]=array_slice($sp500_tickers,0,150);
$tickers[]=array_slice($sp500_tickers,150,150);
$tickers[]=array_slice($sp500_tickers,300,150);
$tickers[]=array_slice($sp500_tickers,450);

$stocks=array();
$sql="INSERT INTO sp500_temp (symbol, name, last_trade, bid_realtime, ask_realtime, bid, ask, date, time, change_realtime, volume, change_day) VALUES ";
$i=0;
...
$connexion->exec("TRUNCATE TABLE sp500_temp");

...
$tickers=Gamemaster::getTickers('ftse');
...
$stocks=array();
$handle = fopen($file, "r");
$sql="INSERT INTO ftse_temp (symbol, name, last_trade, bid_realtime, ask_realtime, bid, ask, date, time, change_realtime, volume, change_day) VALUES ";
...
$connexion->exec("TRUNCATE TABLE ftse_temp");

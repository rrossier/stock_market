...
//$dowjones_tickers=array("AA","AXP","BA","BAC","CAT","CSCO","CVX","DD","DIS","GE","HD","HPQ","IBM","INTC","JNJ","JPM","UNH","KO","MCD","MMM","MRK","MSFT","PFE","PG","T","TRV","UTX","VZ","WMT","XOM");
$tickers=Gamemaster::getTickers('dowjones');
$start=microtime();
$str="'".implode("','", $tickers)."'";
...
$stocks=array();
$handle = fopen($file, "r");
$sql="INSERT INTO dowjones_temp (symbol, name, last_trade, bid_realtime, ask_realtime, bid, ask, date, time, change_realtime, volume, change_day) VALUES ";
...
$connexion->exec("TRUNCATE TABLE dowjones_temp");
